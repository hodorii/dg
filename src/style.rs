...
impl Theme {
    pub fn dark() -> Theme {
        Theme {
            ...
            code: Style::fg(203).with_bg(236),
            code_block: Style::fg(252),
            code_border: Style::fg(240),
            code_lang: Style::fg(245).italic(),
            link: Style::fg(75).underline(),
            link_url: Style::fg(245),
            image: Style::fg(245).italic(),
            quote: Style::fg(250).italic(),
            quote_bar: Style::fg(240),
            bullet: Style::fg(213),
            table_border: Style::fg(240),
            table_head: Style::PLAIN.bold(),
            html: Style::fg(243),
            diagram_caption: Style::fg(245).italic(),
            diagram_line: Style::fg(245),
            diagram_box: Style::fg(110),
            diagram_text: Style::fg(254),
            diagram_group: Style::fg(240),
            diagram_label: Style::fg(179),
            diagram_accent: Style::fg(213),
            diagram_note: Style::fg(179),
