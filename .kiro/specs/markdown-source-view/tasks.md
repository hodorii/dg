...
- [ ] 2. Core — 원문 하이라이팅과 블록 토글
- [ ] 2.1 마크다운 문법 하이라이팅 렌더링
...
- [ ] 3. Core — 드래그 선택과 클립보드
- [ ] 3.1 마우스 프로토콜을 button-event 추적으로 전환
  ...
  - _Boundary: pager 이벤트 루프_
  - _Depends: 2.3_
- [ ] 3.2 Down/Drag/Up 상태 기계로 드래그·클릭 구분
...
- [ ] 5.1 회귀 확인: 기존 테스트 스위트 + clippy
  ...
  - _Boundary: 전체_
  - _Depends: 4.1, 4.2_
- [ ] 5.2 실물 검증: 실제 파일로 전역/블록 토글·하이라이팅 확인
